 ...
 min-[2000px]:ml-[50%] min-[2000px]:translate-x-[-50%] min-[2000px]:w-[2000px]
     ${viewMode === "list"
      ...
      >
        ...
        {loading ? (
          ...
          <section
            className={` ${menuOpen ? "max-[650px]:h-screen overflow-hidden" : ""
              }`}
          >
            {/* Heading */}
            <ul
                ...
                >
                  ...
                  >
                    <img
                      ...
                      className={`${viewMode === "list" ? "h-[80%]" : "h-auto"
                        }`}
                    />
                    {/* grid view */}
                    <div
                    ...
                    >
                      <div className="flex items-center flex-col">
                        <span
                          className={`text-[14px] font-semibold flex items-center  capitalize ${trademark?._source?.status_type === "registered"
                            ? "text-[#41B65C]"
                        ...
                        >
                          <GoDotFill
                            className={`${trademark?._source?.status_type === "registered"
                              ? "text-[#128807]"
                              : trademark?._source?.status_type === "pending"
                                ? "text-yellow-500"
    ...
    ${currentFilter === "Law Firms"
      ...
      ${currentFilter === "Attorneys"
            ...
            <Filter listOption={currentFilter} />
          </div>
          ...
          <div className=" bg-[#fff] drop-shadow-lg w-full px-6 py-4 rounded-lg flex flex-col gap-2.5 pb-8 mt-6 max-[1250px]:pb-6 shadow-md max-[1000px]:hidden">
            ...
            <div className=" bg-[#F1F1F1] py-2.5 px-3  rounded-xl flex items-center gap-2 mt-2 max-[1250px]:py-2">
              <button
                className={` w-[50%] rounded-xl py-2 text-[#000000] text-[14px] max-[1250px]:text-[12px] max-[1250px]:rounded-lg font-medium  ${viewMode === "list" ? "bg-[#FFFFFF] font-semibold" : ""
                  }`}
              ...
              <button
                className={` w-[50%] rounded-xl py-2 text-[#000000] text-[14px] max-[1250px]:text-[12px] max-[1250px]:rounded-lg font-medium ${viewMode === "grid" ? "bg-[#FFFFFF] font-semibold" : ""
                  }`}
